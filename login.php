...
<body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          ...
          <?php
			...
			?> 
                    <div style="color: red;">
                        ERRO DE ACESSO AO BANCO DE DADOSd
		            </div>
            <?php
					//session_unset();
				}
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <p>Um serviço completo para atender as necessidades da sua empresa. Faça login para ter acesso aos sistemas da sua empresa!</p>
<!--         <p><a class="btn btn-primary btn-lg" href="#" role="button">Leia mais &raquo;</a></p> -->
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4">
          <h2>Comércio Eletrônico iBolt</h2>
        ...
        <div class="col-md-4">
          <h2>iBolt NF-e</h2>
          <p>Solução simples para você que tem a necessidade de emitir notas fiscais eletrônicas. </p>
          <p><a class="btn btn-default" href="#" role="button">Leia mais &raquo;</a></p>
       </div>
        <div class="col-md-4">
          <h2>iboltPag</h2>
          <p>Plataforma de controle de pagamentos de boletos e cartões com simplicidade de uso e eficiência. </p>
          <p><a class="btn btn-default" href="#" role="button">Leia mais &raquo;</a></p>
        </div>
        <div class="col-md-4">
          <h2>ERP iBolt</h2>
          <p>Um sistema de gestão completo e totalmento personalizado de maneira exclusiva para sua empresa. </p>
          <p><a class="btn btn-default" href="#" role="button">Leia mais &raquo;</a></p>
        </div>
      </div>
      <hr>

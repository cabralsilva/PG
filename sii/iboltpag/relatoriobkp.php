	                    		...
	                    		<div align="right">Funcionário logado: <?php echo $_SESSION["dados_acesso"][0]["nome_usuario"] ?>
							    	<div class="btn-group">
						    			...
						    			<ul class="dropdown-menu">
						    				<li><a href="relatorio.php">Relatório de Transações</a></li>
                   			...
                   			<thead>
                   				<tr>
	                                <th class="col-md-1"><center>
	                                	TRANSAÇÃO</center></th> 
	                                <th class="col-md-1"><center>
	                                	<select class="form-control selectpicker" id="selecaoOperadora" multiple data-selected-text-format="count > 2" title="Todos" data-width="100%" multiple>
	                                ...
	                                <th class="col-md-1"><center>
	                                	<select class="form-control selectpicker" id="selecaoStatus" multiple data-selected-text-format="count > 2" title="Todos" data-width="100%" multiple>
	                                ...
	                                <th class="col-md-1" style="width: 10%;"><center>
		                                <select class="form-control selectpicker" id="selecaoFormaPagamento" multiple data-selected-text-format="count > 2" title="Todos" data-width="100%" multiple>
	                                ...
	                                <th class="col-md-1" style="width: 10%;"><center><div class="input-group">

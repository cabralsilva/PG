...
function converterUnicode(texto){
	
	texto = replaceAll(texto, "\\u00c3\\u00a0", "à");
	texto = replaceAll(texto, "\\u00c3\\u00a1", "á");
	texto = replaceAll(texto, "\\u00c3\\u00a2", "â");
	texto = replaceAll(texto, "\\u00c3\\u00a3", "ã");
	texto = replaceAll(texto, "\\u00e4", "ä");
	texto = replaceAll(texto, "\\u00c3\\u0080", "À");
	texto = replaceAll(texto, "\\u00c3\\u0081", "Á");
	texto = replaceAll(texto, "\\u00c2", "Â");
	texto = replaceAll(texto, "\\u00c3\\u0083", "Ã");
	texto = replaceAll(texto, "\\u00c4", "Ä");
	texto = replaceAll(texto, "\\u00c3\\u00a8", "è");
	texto = replaceAll(texto, "\\u00c3\\u00a9", "é");
	
	texto = replaceAll(texto, "\\u00c3\\u00aa", "ê");
	texto = replaceAll(texto, "\\u00c3\\u0089", "É");
	texto = replaceAll(texto, "\\u00c3\\u0088", "È");
	texto = replaceAll(texto, "\\u00ca", "Ê");
	texto = replaceAll(texto, "\\u00cb", "Ë");
	texto = replaceAll(texto, "\\u00c3\\u00ad", "í");
	texto = replaceAll(texto, "\\u00c3\\u00ac", "ì");
	texto = replaceAll(texto, "\\u00ee", "î");
	texto = replaceAll(texto, "\\u00ef", "ï");
	texto = replaceAll(texto, "\\u00cd", "Í");
	texto = replaceAll(texto, "\\u00cc", "Ì");
	texto = replaceAll(texto, "\\u00cf", "Ï");
	texto = replaceAll(texto, "\\u00c3\\u00b3", "ó");
	texto = replaceAll(texto, "\\u00f2", "ò");
	texto = replaceAll(texto, "\\u00c3\\u00b4", "ô");
	texto = replaceAll(texto, "\\u00c3\\u00b5", "õ");
	texto = replaceAll(texto, "\\u00f6", "ö");
	texto = replaceAll(texto, "\\u00d3", "Ó");
	
	texto = replaceAll(texto, "\\u00c3\\u0092", "Ò");
	texto = replaceAll(texto, "\\u00d4", "Ô");
	texto = replaceAll(texto, "\\u00d5", "Õ");
	texto = replaceAll(texto, "\\u00d6", "Ö");
	texto = replaceAll(texto, "\\u00fa", "ú");
	texto = replaceAll(texto, "\\u00f9", "ù");
	texto = replaceAll(texto, "\\u00fb", "û");
	texto = replaceAll(texto, "\\u00fc", "ü");
	
	texto = replaceAll(texto, "\\u00da", "Ú");
	texto = replaceAll(texto, "\\u00d9", "Ù");
	texto = replaceAll(texto, "\\u00db", "Û");
	texto = replaceAll(texto, "\\u00e7", "ç");
	texto = replaceAll(texto, "\\u00c7", "Ç");
	texto = replaceAll(texto, "\\u00f1", "ñ");
	texto = replaceAll(texto, "\\u00d1", "Ñ");
                                ...
                                "<table id='table2' class='table table-hover table-striped'>" +
                                    ...
                                    "<tbody>" +
                                        "<tr class='info'>";
											switch(obj[i].Origem){
												case "0":
													table += "<td><center>Avulso</center></td>";
													break;
												case "1":
													table += "<td><center>Pedido</center></td>";
													break;
												case "2":
													table += "<td><center>Faturamento</center></td>";
													break;
												case "3":
													table += "<td><center>Tipo 3</center></td>";
													break;
												case "4":
													table += "<td><center>Tipo 4</center></td>";
													break;
												case "5":
													table += "<td><center>Tipo 5</center></td>";
													break;
												case "6":
													table += "<td><center>Tipo 6</center></td>";
													break;
												case "7":
													table += "<td><center>Tipo 7</center></td>";
													break;
												case "8":
													table += "<td><center>Tipo 8</center></td>";
													break;
												case "9":
													table += "<td><center>Tipo 9</center></td>";
													break;
												default:
													table += "<td><center>Não identificada</center></td>";
													break;
									    	}
                                        	table += "<td><center>" + obj[i].CodPedido + "</center></td>"; 
                                                        ...
                                                        "<td><center>";
                                                    			switch(obj[i].listaPagamentos[indTransacao].IdOperadora){
                                                                	...
                                                                	case '2':
                                                                		...
                                                                		break;
                                                                	case '3':
                                                                		if (obj[i].listaPagamentos[indTransacao].idBoleto) {
                                                                            table += obj[i].listaPagamentos[indTransacao].idBoleto;
                                                                		}
                                                                        else table += "--";
                                                                		break;
                                                                	case '4':
...
//                                                            		console.log(obj[i].listaPagamentos[indTransacao].idFormaPagamento);
                                                            		if (obj[i].listaPagamentos[indTransacao].idFormaPagamento != 22){
                                                            			switch(obj[i].listaPagamentos[indTransacao].StatusTransPag){
	                                                            			case "0":
                                                            			...
                                                            			table += 	"<li><a data-transacao='" + $.map(obj[i].listaPagamentos[indTransacao], function(el, ind) {if (el == null) el = ""; return el }) + "' data-toggle='dropdown' href='#' onClick='imprimirBoleto(this)'>Imprimir Boleto</a></li>";
                                                            		}
